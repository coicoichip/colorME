...
class SupportContainer extends Component {
    ...
    support(value){
        ...
        console.log(SupportStore.isLoading + ".........");
    ...
    render() {
        ...
        return (
            <Container style={styles.wrapperContainer}>
                <Header title={STRINGS.SUPPORT_HEADER_TITLE} navigate={navigate} />
                <FlatList
                    showsVerticalScrollIndicator={false}
                    ListHeaderComponent={
                        <View>
                            <View style={[styles.wrapperContainer, styles.paddingLeftRight]}>
                                <Text style={styles.textDescriptionDark}>Cảm ơn bạn đã gửi phản hồi đến ColorME. Chúng tôi sẽ hỗ trợ bạn trong thời gian sớm nhất.</Text>
