...
@observer
class RequestFunction extends Component {
    // constructor(props) {
    //     super(props);
    //     this.state = {
    //         title: "",
    ...
    // }
    componentDidMount(){
        Analytics.trackEvent(`${STRINGS.ACTION_ROOT_DRAWER_REQUEST_FUCTION}`, {});
    }
    ...
    render() {
        ...
        return (
            <Container style={styles.wrapperContainer}>
                <Header title={STRINGS.REQUEST_FUNCTION} navigate={navigate} />
                <FlatList
                    showsVerticalScrollIndicator={false}
                    ListHeaderComponent={
                        <View>
                            <View style={[styles.wrapperContainer, styles.paddingLeftRight]}>
                                <Text style={styles.textDescriptionDark}>Bạn có yêu cầu cần thêm tính năng nào không? Hãy gửi cho chúng tôi để chúng tôi sẽ hỗ trợ bạn trong thời gian sớm nhất !</Text>
