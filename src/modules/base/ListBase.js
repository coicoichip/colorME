                ...
                >
                    ...
                    <View style={[styles.contentCardImageInformation]}>
                        ...
                        <View style={{ flexDirection: "row", marginTop: 5 }}>
                            <TouchableOpacity
                                activeOpacity={0.8}
                                style={[styles.wrapperRowCenter,{backgroundColor: GREEN_COLOR,fontSize: 12, fontFamily: 'Helvetica', color: "white",width:80,height:30,borderRadius: 5,}]}
                                onPress={
                                    () => showLocation({
                            ...
                            <TouchableOpacity
                                activeOpacity={0.8}
                                style={[styles.wrapperRowCenter,{backgroundColor: BLUE_COLOR,fontSize: 12, fontFamily: 'Helvetica', color: "white",width:60,height:30,borderRadius: 5, marginLeft: 10,}]}
